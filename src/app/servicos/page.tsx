...
export default function ServicosPage() {
  const services = [
    ...
    { title: "Pigmentação", description: "Preenchimento capilar profissional", price: "R$ 80", duration: "45 min", image: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=400&q=80&fit=crop&crop=bottom" },

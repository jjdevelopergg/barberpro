    ...
    <div>
      ...
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", textAlign: "center" }}>
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto", padding: "140px 24px 100px", position: "relative", zIndex: 1 }}>
          <div className="animate-fade-up">
            <p style={{ color: "#bbb", fontSize: "12px", fontWeight: 500, letterSpacing: "4px", textTransform: "uppercase", marginBottom: "28px" }}>
              Agendamento Online
            </p>
          </div>
          ...
          <h1 className="animate-fade-up-delay-1" style={{ fontSize: "clamp(2.8rem, 7vw, 5rem)", fontWeight: 800, lineHeight: 0.95, letterSpacing: "-2px", color: "#fff" }}>
            Seu horário,<br />
            <span style={{ color: "#bbb", fontWeight: 300, fontStyle: "italic" }}>sua escolha</span>
          </h1>

          <p className="animate-fade-up-delay-2" style={{ color: "#ccc", marginTop: "24px", fontSize: "16px", lineHeight: "1.8", maxWidth: "500px", margin: "24px auto 0" }}>
      ...
      <section style={{ padding: "120px 24px", backgroundColor: "#050505" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div className="animate-fade-up" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "48px" }}>
            ...
            <Link href="/servicos" style={{ color: "#bbb", fontSize: "13px", textDecoration: "none", display: "flex", alignItems: "center", gap: "4px" }}
            ...
            {services.map((service, i) => (
              <div key={i} className={`img-hover animate-fade-up-delay-${i + 1}`} style={{ position: "relative", height: "400px", borderRadius: "16px", overflow: "hidden" }}>
                ...
                <div style={{ position: "absolute", bottom: "24px", left: "24px" }}>
                  ...
                  <p style={{ color: "#ccc", fontSize: "13px", marginTop: "4px" }}>{service.description}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1px", backgroundColor: "#1a1a1a", borderRadius: "16px", overflow: "hidden" }} className="grid-responsive-2">
            {[
              ...
              <div key={i} style={{ backgroundColor: "#0a0a0a", padding: "40px 28px" }}>
                ...
                <p style={{ color: "#aaa", fontSize: "13px", marginTop: "8px", lineHeight: "1.6" }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "120px 24px", borderTop: "1px solid #111" }}>
        <div style={{ maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ color: "#aaa", marginTop: "16px", fontSize: "15px", lineHeight: "1.7" }}>
